...
export default function Add({navigation}){
  ...
  return (
    <View>
      <View style = {styles.layout}>
        ...
        <View style={styles.save}><Button title = "Save Background" color="#3BE2B0" onPress = {() => navigation.navigate('SaveBackground',{image})}/></View>
      </View>
  ...
  //     <Button title = "Save Background" onPress = {() => navigation.navigate('SaveBackground',{image})}/>
